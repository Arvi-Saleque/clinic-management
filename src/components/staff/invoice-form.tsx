  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <div className="ml-auto max-w-sm rounded-2xl border border-primary/12 bg-primary-soft/40 p-4">
        ...
        <div className="space-y-2 text-xs"><div className="flex justify-between text-muted-foreground"><span>Subtotal</span><span>{formatCurrency(subtotal)}</span></div><div className="flex justify-between text-muted-foreground"><span>Discount</span><span>-{formatCurrency(discount)}</span></div><div className="flex justify-between text-muted-foreground"><span>Tax</span><span>{formatCurrency(tax)}</span></div><div className="mt-2 flex justify-between border-t border-primary/15 pt-3 font-heading text-base font-extrabold"><span>Total</span><span>{formatCurrency(total)}</span></div></div>
      </div>
