  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">Select a patient, chart each tooth using a 3D-style FDI model, and document the finding, recommended care, priority, date and estimated fee.</p>
      </div>
