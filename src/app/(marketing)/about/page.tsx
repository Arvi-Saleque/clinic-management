...
export const metadata: Metadata = {
  ...
  description: "Learn about our philosophy, modern dental technologies, and dedicated clinical team.",
};
...
const clinicValues = [
  {
    ...
    desc: "A serene clinic environment with gentle local anaesthesia tailored for relaxed visits.",
    icon: Smile,
  },
  {
    title: "Custom Restorations",
    desc: "High-grade medical ceramics shade-matched to your unique natural tooth colour.",
    icon: Award,
  },
  {
    title: "Transparent Guidance",
    desc: "Clear treatment discussions so you understand the proposed care before proceeding.",
    icon: ShieldCheck,
  },
];
  ...
  return (
    <div className="about-page">
      <main>
        ...
        <section className="page-hero-banner py-20 text-white">
          <div className="container text-center max-w-4xl mx-auto px-4">
            ...
            <h1 className="page-title text-4xl sm:text-5xl md:text-6xl font-light tracking-tight leading-tight drop-shadow-md">
              ...
              <i className="font-serif text-[#9CB080]">To Modern Dentistry.</i>
            </h1>
        ...
        {/* Founder Story & Clinical Philosophy Section */}
        <section className="story-section py-24 bg-white text-[#273338]">
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              <div className="story-text-col lg:col-span-7 space-y-6">
                <span className="subtitle-italic text-[#2B5748] font-semibold text-sm">Our Care Philosophy</span>
                <h2 className="h3 text-3xl sm:text-4xl md:text-5xl font-light text-[#182320] tracking-tight leading-tight">
                  Personalized Care <br />
                  <i className="font-serif text-[#2B5748]">Built Around You.</i>
                </h2>
                <div className="h-0.5 w-12 bg-[#9CB080]" />

                <p className="text-[#414a4c] text-base leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 pt-4">
                  {clinicValues.map((val, idx) => {
                    ...
                    return (
                      <div key={idx} className="p-5 rounded-2xl bg-[#F8F9F8] border border-[#273338]/08 shadow-sm">
                        <div className="w-9 h-9 rounded-xl bg-[#2B5748]/10 flex items-center justify-center text-[#2B5748] mb-3">
                          <ValIcon className="w-5 h-5 text-[#2B5748]" />
                        </div>
                        <h4 className="text-sm font-bold text-[#182320] mb-1">{val.title}</h4>
                        <p className="text-xs text-[#52605B] leading-relaxed">{val.desc}</p>
                      </div>
                    );
                  })}
                </div>
        ...
        <section className="tech-showcase-section relative py-28 text-white overflow-hidden bg-[#1B2623]">
          {/* Ambient Glows */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-7 text-left w-full">
              {techStack.map((tech, idx) => {
                ...
                return (
                  ...
                  >
                    <div>
                      <div className="w-12 h-12 rounded-2xl bg-[#9CB080]/20 flex items-center justify-center text-[#B5C89B] mb-6 group-hover:bg-[#9CB080] group-hover:text-[#182320] transition-colors duration-300 shadow-md">
